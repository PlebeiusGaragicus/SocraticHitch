...
> `Hitch` (v). move (something) into a different position with a jerk
...
[argument.py](./argument.py) gives a 'pseudo-code' like format to a "Socratic" argument

We provide several example arguments.