---
author: npub123456... <nostr public key>
event: nevent123456... <nostr event id>
title: "Coding Agents and the Next Era"
date: 2026-01-01
...
**Source:** Karpathy, A. [@karpathy]. (2025, February 2). *There's a new kind of coding I call "vibe coding", where you fully give in to the vibes, embrace exponentials, and forget that the code even exists.* [Post]. X. https://x.com/karpathy/status/1886192184808149383?lang=en
...
`Abstraction Layers:` The history of computing is a series of abstraction layers (Binary -> Assembly -> C -> Python -> AI Agents).

---

`Intent-Driven Development:` A paradigm where the primary input is the desired outcome rather than the steps to achieve it.
...
`Domain Expert-Architects:` Individuals who possess deep knowledge in a specific field and use agents to translate that knowledge into software.
...
`Agentic Symbiosis:` A relationship where humans provide direction and intuition, while AI provides execution and optimization.

---

`Project Soul:` The core purpose and unique value proposition that differentiates a project, which must be protected from "generic AI" drift.
...
**Source:** Moore, J., & Haber, N. (2024, May 22). *Exploring the Dangers of AI in Mental Health Care*. Stanford HAI. https://hai.stanford.edu/news/exploring-the-dangers-of-ai-in-mental-health-care
